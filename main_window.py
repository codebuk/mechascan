...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.check_tpt = QtWidgets.QCheckBox(self.widget)
        self.check_tpt.setChecked(True)
        self.check_tpt.setTristate(False)
        self.check_tpt.setObjectName("check_tpt")
        self.gridLayout_3.addWidget(self.check_tpt, 8, 0, 1, 2)
        self.check_led = QtWidgets.QCheckBox(self.widget)
        self.check_led.setChecked(True)
        self.check_led.setTristate(False)
        self.check_led.setObjectName("check_led")
        self.gridLayout_3.addWidget(self.check_led, 9, 0, 1, 2)
        self.check_cam = QtWidgets.QCheckBox(self.widget)
        self.check_cam.setChecked(True)
        self.check_cam.setTristate(False)
        self.check_cam.setObjectName("check_cam")
        self.gridLayout_3.addWidget(self.check_cam, 7, 0, 1, 2)
        self.cb_auto_home = QtWidgets.QCheckBox(self.widget)
        self.cb_auto_home.setStyleSheet(
            "font: 9pt \"Cqlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 rgba(0, 0, 0, 255), stop:1 rgba(255, 255, 255, 255))rgb(255, 255, 255)antarell\";\n"
            "font: 11pt \"Carlito\";")
        self.cb_auto_home.setChecked(True)
        self.cb_auto_home.setTristate(False)
        self.cb_auto_home.setObjectName("cb_auto_home")
        self.gridLayout_3.addWidget(self.cb_auto_home, 5, 0, 1, 2)
        ...
        self.pushButton = QtWidgets.QPushButton(self.dock_hardware_2)
        self.pushButton.setCheckable(True)
        self.pushButton.setChecked(False)
        self.pushButton.setObjectName("pushButton")
        self.gridLayout_2.addWidget(self.pushButton, 1, 0, 1, 2)
        self.vl_hardware.addLayout(self.gridLayout_2)
        self.pushButton_2 = QtWidgets.QPushButton(self.dock_hardware_2)
        self.pushButton_2.setObjectName("pushButton_2")
        self.vl_hardware.addWidget(self.pushButton_2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton.setText(_translate("MainWindow", "Lamp"))
